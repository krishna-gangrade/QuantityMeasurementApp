...
public class SignUpRequest {
    ...
    public static class SignUpRequestBuilder {
        ...
        public SignUpRequestBuilder mobileNo(String mobileNo) { this.mobileNo = mobileNo; return this; }

        public SignUpRequest build() {
            return new SignUpRequest(firstName, lastName, email, password, mobileNo);
        }
    }
